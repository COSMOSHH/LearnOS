...
10. 支持查看学习报告，汇总资料、知识点、问答和最近一次测验表现。
11. 支持查看历史学习会话，并删除当前学习会话。
12. 支持流式回答、来源展示、复习提醒展示。
...
4. 问答、自测、报告、复习项已经形成基础学习闭环。
5. 保留多 Agent 架构基础，便于后续继续接学习计划、评测和面试模式。
...
5. 切到“测验模式”生成一套题，提交答案看评分反馈。
6. 切到“学习报告”刷新复盘结果，展示本轮学习的进展、风险和下一步建议。
...
3. 测验结果已经可生成评分反馈，但“错题自动回流成复习项”还未打通。
