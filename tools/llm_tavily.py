...
llm = ChatOpenAI(
    temperature=0,
    model='qwen-plus',  # 可根据需求替换为 qwen-max 或 qwen-turbo
    base_url="https://dashscope.aliyuncs.com/compatible-mode/v1",
    api_key=os.environ.get("DASHSCOPE_API_KEY") # 如果你环境变量配的是 OPENAI_API_KEY，这行可以不写或改成获取 OPENAI_API_KEY
)

# 初始化搜索工具，限制结果数量为1
os.environ["TAVILY_API_KEY"] = "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"
tavily_tool = TavilySearchResults(max_results=1)
